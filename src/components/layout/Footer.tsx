				...
				<div className="grid gap-12 md:grid-cols-4">
					...
					<div className="md:col-span-2">
						<div className="mb-4 flex items-center gap-2">
							<span className="text-2xl font-extrabold text-white">YUP</span>
					...
					<div>
						...
						<ul className="space-y-3 text-sm">
							<li>
								<a href="#intro" className="transition-colors hover:text-yup">
									Giới thiệu
								</a>
							</li>
							<li>
							...
							<li>
								<a href="#schedule" className="transition-colors hover:text-yup">
									Lịch trình
								</a>
							</li>
							<li>
								<a href="#instructors" className="transition-colors hover:text-yup">
									Giảng viên
								</a>
							</li>
							<li>
